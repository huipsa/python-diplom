...
class ShopFormState(forms.ModelForm):
    class Meta:
        model = Shop
        fields = ('state',)
...
class OrderFilterForm(forms.Form):
    state = forms.ChoiceField(choices=[('basket', 'Basket'), ('in_progress', 'In Progress'), ('completed', 'Completed')])
    ...
    def clean(self):
        ...
        if state and not (shop_name or min_date or max_date):
